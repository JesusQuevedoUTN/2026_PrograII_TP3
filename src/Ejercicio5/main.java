...
Se desea diseñar un programa para registrar y persistir en archivos la 
información de las reservas de una empresa dedicada al alquiler de automóviles, 
teniendo en cuenta que:

- De cada cliente se desean almacenar su DNI, nombre y apellido, dirección y 
...
alquiler de cada uno de los autos, el precio total de la reserva y un indicador 
de si el auto o los autos han sido entregados.
